...
let subcommandDescriptions = [
    ...
    ["  close-all-windows-but-current", "On the focused workspace, close all windows but the current one"],
    ...
    ["  list-apps", "Print the list of running applications that appear in the Dock and may have a user interface"],
    ...
    ["  macos-native-minimize", "Minimize the focused window"],
    ["  mode", "Activate the specified binding mode"],
    ["  move-mouse", "Move the mouse to the requested position"],
    ...
    ["  trigger-binding", "Trigger AeroSpace binding as if it was pressed by the user"],
