...
let list_windows_help_generated = """
    USAGE: list-windows [-h|--help] (--workspace <workspace>...|--monitor <monitor>...)
       ...
       OR: list-windows [-h|--help] --all [--format <output-format>] [--count] [--json] [--sort-by <sort-key>...]
       OR: list-windows [-h|--help] --focused [--format <output-format>] [--count] [--json] [--sort-by <sort-key>...]
    """
