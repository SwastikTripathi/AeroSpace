...
Switching to a different tiling window within the same workspace while the currently focused window is in fullscreen mode results in the fullscreen window exiting fullscreen mode.
