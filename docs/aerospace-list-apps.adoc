...
// tag::purpose[]
:manpurpose: Print the list of running applications that appear in the Dock and may have a user interface
// end::purpose[]
...
The command is useful for inspecting the list of applications to compose a filter for the xref:guide.adoc#on-window-detected-callback[on-window-detected callback].
