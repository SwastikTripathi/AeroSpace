...
Workspaces that are listed in `persistent-workspaces` are printed first in the order they are listed in.
The rest of the workspaces are printed last in alphabetical order
