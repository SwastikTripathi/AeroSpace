...
%{window-parent-container-orientation}:: String. The orientation (`horizontal`, `vertical`) of the window's parent container.
...
%{workspace-root-container-orientation}:: String. The orientation (`horizontal`, `vertical`) of the root container of the workspace the window belongs to.
