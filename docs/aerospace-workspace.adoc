...
* Otherwise, *the list* is defined as all workspaces (even empty ones) on focused monitor.
Workspaces that are listed in `persistent-workspaces` go first in the order they are listed in.
The rest of the workspaces go last in alphabetical order
