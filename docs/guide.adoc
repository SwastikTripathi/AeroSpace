...
The padding is either a number of pixels (`accordion-padding = 30`) or a percentage of the monitor size (`accordion-padding = '2%'`).
The percentage is relative to the monitor width in horizontal accordions, and to the monitor height in vertical accordions (not counting the menu bar and the Dock).
Percentages are handy if you use monitors of different sizes.
